...
function Card(props: CardProps) {
  const { card, boardId, removeCard, onDragEnd, onDragEnter, updateCard, number } = props;
    ...
    <>
      ...
      >
        <div className="card-top">
          <div className="card-top-number">№{number}</div>
          ...
          >
            ...
            {showDropdown && (
              ...
              >
                <p onClick={() => removeCard(boardId, id)}>Удалить карточку</p>
              </Dropdown>
            )}
          </div>
        </div>
